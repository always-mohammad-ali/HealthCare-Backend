...
export const createDoctorZodSchema = z.object({
    password: z.string("Password is required").min(6, "password at least 6 character").max(20, "password at most 15 character"),
    doctor: z.object({
        ...
        appoinmentFee: z.number("Appointment fee must be a number").nonnegative("Appointment fee cannot be negative"),
